...
**Next stop:** implementing the Transformer from scratch, following [Umar Jamil’s YouTube video](https://www.youtube.com/watch?v=ISNdQcPhsts&t=232s).

Dataset Link- https://huggingface.co/datasets/Helsinki-NLP/opus-100/viewer/en-hi , https://huggingface.co/datasets/cfilt/iitb-english-hindi/viewer/default/test
